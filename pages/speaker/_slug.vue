...
export default {
  ...
  head () {
    ...
    const metaImage = this.speaker.metaImage ? 'https://adoptingbitcoin.org/speaker-meta/' + this.speaker.metaImage : 'https://adoptingbitcoin.org/adopting_bitcoin_meta_preview_q.jpg'
    return {
      htmlAttrs: {
        ...i18nHead.htmlAttrs
      },
